...
def show_explore_page():
    st.title(" EXPLORE Software Develper Salary - Latest")
    st.write("""### Datas are collected from Stack Overflow Developer Survey...""")
    st.markdown(
    """
    <style>
    ...
    ax1.pie(data, labels=data.index, autopct="%1.1f%%", startangle=10)
    ax1.axis("equal")
